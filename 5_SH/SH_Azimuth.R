...
## Description | Harmony까지 적용한 data에 대한 Azimuth 분석 결과 시각화
# ============================================================
...
pdf('0.1_Azimuth_annotation.pdf', width=8, height=8)
DimPlot(obj, reduction='umap_r1.0', group.by="azimuth_type", label=TRUE, repel=TRUE)+
...
pdf("umap_azimuth_highlight.pdf", width=8, height=6)
