...
## Description | MAST DEG RDS들을 불러와 sign(FC)×−log10(p) 랭크로 Reactome/GO:BP GSEA를 실행
## 대비별로 TSV 결과 + Top± enrichment·Diverging barplot·Up/Down dotplot·cnetplot 저장
## padj<0.25=0이면 fgsea와 FC-랭크 결과도 함께 저장
## =========================================
