...
## Description | HY vs HO 비교만 대상으로 MAST DEG를 3가지 랭크(fc×p, sign×p, fc-only)로 정렬 
## Hallmark/Reactome/GO:BP GSEA(fgsea) 재실행, 각 조합의 결과 TSV + Diverging barplot을 GSEA_results_HYvsHO_boost/에 저장
## ============================================================
